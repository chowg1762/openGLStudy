...
int LightingMap::createVertexShader(const char *vertexShader){
...
int LightingMap::createFragmentShader(const char *fragmentShader)
{
...
int LightingMap::createProgram(const char *vertexShader, const char *fragmentShader){
    int success;
    char infoLog[512];
...
unsigned int LightingMap::createTexture(std::string filePath, bool isRGBA){
...
void LightingMap::drawCube(){
    glBindVertexArray(CUBE_VAO);
    glDrawArrays(GL_TRIANGLES, 0, 36);
    glBindVertexArray(0);
}

void LightingMap::drawLamp(){
    glBindVertexArray(LIGHT_VAO);
    glDrawArrays(GL_TRIANGLES, 0, 36);
    glBindVertexArray(0);
}

void LightingMap::destroyCube(){
    glDeleteVertexArrays(1, &CUBE_VAO);
    glDeleteBuffers(1, &CUBE_VBO);
}

void LightingMap::destroyLamp(){
    glDeleteVertexArrays(1, &LIGHT_VAO);
}

void LightingMap::initMVPMatrix(unsigned int shaderProgramID){
...
void LightingMap::initLampMatrix(unsigned int shaderProgramID){
    glm::mat4 model = glm::mat4(1.0f);
